...
urlpatterns = [
    ...
    path(
        "api/v1/auth/email-code-login/send-code",
        EmailCodeLoginSendView.as_view(),
        name="email_code_login_send",
    ),
    path(
        "api/v1/auth/email-code-login/verify",
        EmailCodeLoginVerifyView.as_view(),
        name="email_code_login_verify",
    ),
